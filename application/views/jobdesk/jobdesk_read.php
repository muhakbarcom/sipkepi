        ...
        <div class="box">
            ...
            <div class="box-body">
                <table class="table">
                    ...
                    <?php if (!$this->ion_auth->is_admin() and !$this->ion_auth->in_group("Human Resource")) : ?>
                        <tr>
                            <td>
                                <?php echo form_open_multipart(base_url('jobdesk/upload_jobdesk')); ?>
                                <input type="file" name="file_jobdesk">
                                <input type="hidden" name="id_jobdesk" value="<?php echo $id_jobdesk; ?>">

                            </td>
                            <td> <button type="submit" class="btn btn-primary">upload </button>
                    ...
                    <tr>
                        <?php if ($this->ion_auth->in_group("Pegawai")) { ?>
                            <td><a href="<?php echo site_url('jobdesk/pegawai') ?>" class="btn bg-purple">Cancel</a></td>
                        <?php } else { ?>
                            <td><a href="<?php echo site_url('jobdesk') ?>" class="btn bg-purple">Cancel</a></td>
